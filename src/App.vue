          ...
          >
            ...
            <q-card-section class="q-pb-none">
              ...
              <div class="info-grid">
                <p>
                  <q-icon name="build" />
                  <span><b>Reparación:</b> {{ formatearReparaciones(servicio.reparacion) }}</span>
                </p>
                <p>
                  <q-icon name="badge" />
            ...
            <div class="row q-col-gutter-md">
              ...
              <div class="col-12 col-sm-6">
                <q-select
                  ...
                  :rules="[val => val.length > 0 || 'Seleccione al menos una opción']"
                />
              </div>
              ...
              <div v-if="form.estado === 'Recibido'" class="col-12">
                <q-input
                  v-model="form.obs"
                  type="textarea"
...
function obtenerImagenPorDefecto(tipo) {
  if (Array.isArray(tipo) ? tipo.includes('Cambio de pantalla') : tipo === 'Cambio de pantalla') {
...
function formatearReparaciones(reparacion) {
  return Array.isArray(reparacion) ? reparacion.join(', ') : reparacion
}
